...
class FinalInspection(Base):
    ...
    # JSONB columns
    equipments: Mapped[List[Any]] = mapped_column(JSONB, nullable=False, default=list)
    sent_emails: Mapped[List[Any]] = mapped_column(JSONB, default=list)
    ...
    customer = relationship("Customer", back_populates="final_inspections")
