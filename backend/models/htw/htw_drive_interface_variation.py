...
class HTWDriveInterfaceVariation(Base):
    __tablename__ = "htw_drive_interface_variation"
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            name="chk_drive_interface_position_deg"
        ),
        UniqueConstraint(
            "job_id", "position_deg",
            name="uq_drive_interface_job_position"
        ),
    )
